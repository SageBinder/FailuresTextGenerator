...
class TextGenerator:
    ...
    def generate_chars_list(self,
                            ...
                            # If the model takes too long to generate an <eom> in the
        ...
        for c, _seed_chars in self.generate_chars(num_chars,
            ...
            while True:
                next_char, _seed_chars = \
                    self.__generate_next_char(seed_chars=_seed_chars,
                                              ...
                                              digit_temperature=digit_temperature)
                if print_progress:
                    print("Generated '" + str(next_char) + "' from seed " + str("".join(_seed_chars)))
                yield (next_char, _seed_chars)

    def generate_messages_list(self,
        ...
        messages_list = []
        _seed_chars = seed_chars
        for message, _seed_chars in self.generate_messages(num_messages,
                                                           seed_chars=_seed_chars,
                                                           min_seed_chars_generated=min_seed_chars_generated,
                                                           max_seed_chars_before_delimiter=max_seed_chars_before_delimiter,
                                                           random_seed=random_seed,
        ...
        return messages_list, _seed_chars
        ...
        if num_messages is not None:
            for i in range(num_messages):
                message, _seed_chars = self.generate_message(seed_chars=_seed_chars,
                                                             ...
                                                             print_progress=print_progress)
                if print_progress:
                    print("Message " + str(i) + '/' + str(num_messages) + ': "' + message + '"')
                yield message, _seed_chars
        else:
            while True:
                message, _seed_chars = self.generate_message(seed_chars=_seed_chars,
                                                             min_seed_chars_generated=min_seed_chars_generated,
                                                             ...
                                                             print_progress=print_progress)
                if print_progress:
                    print('Generated: "' + message + '" from seed ' + str("".join(_seed_chars)))
                yield message, _seed_chars
    ...
    while True:
        while True:
            try:
                ...
                seed = int(inp[1]) if len(inp) >= 2 else None
                break
            except ValueError:
        ...
        if num_messages > 0:
            print("Generating...")
            messages, seed_chars = generator.generate_messages_list(num_messages=num_messages,
            ...
            print("Generating 1000 chars...")
            # print(""
            #       .join("\n" if c == generator.message_delimiter else c for c in generator.generate_chars_list(1000)[0]))
            for c, _ in generator.generate_chars(1000):
                print("<Enter>\n" if c == generator.message_delimiter else c, end="")
                sys.stdout.flush()
            print()
